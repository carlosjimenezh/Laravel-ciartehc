...
class TeamSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $team->frase = 'En la intersección de la historia y la imaginación, encontramos el poder para transformar el presente y moldear el futuro';
        $team->imagen = '/storage/team/jorge.png';
        ...
        $team->imagen = '/storage/team/rosa.png';
        $team->frase = 'La verdadera belleza del arte y la humanidad radica en la capacidad de inspirar y conectar corazones a través de nuestras historias y emociones';
        ...
        $team->extension = '46073';
        $team->email = '';
        $team->imagen = '/storage/team/edith.png';
        $team->semblanza = '';
        $team->frase = 'Cada obra es un reflejo de la pasión y el propósito. Cultiva tu arte con amor y verás florecer tus sueños';
        $team->cv = '';
        $team->activo = true;
        $team->save();
